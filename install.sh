...
check_dependencies() {
    ...
    if [ ${#missing_deps[@]} -gt 0 ]; then
        ...
        echo -e "    ${YELLOW}║${NC}  Install: ${missing_deps[*]}"
        echo -e "    ${YELLOW}╚════════════════════════════════════════════════════════╝${NC}"
        echo ""
        return 1
    fi
...
do_install() {
    ...
    if is_installed; then
        ...
        echo -e "${NEON_GREEN}║${NC}                                                              ${NEON_GREEN}║${NC}"
        echo -e "${NEON_GREEN}║${NC}  ${WHITE}Location:${NC}  ${NEON_CYAN}${INSTALL_DIR}/${SCRIPT_NAME}${NC}                        ${NEON_GREEN}║${NC}"
        echo -e "${NEON_GREEN}║${NC}  ${WHITE}Version:${NC}   ${NEON_YELLOW}${VERSION}${NC}                                            ${NEON_GREEN}║${NC}"
        echo -e "${NEON_GREEN}║${NC}                                                              ${NEON_GREEN}║${NC}"
