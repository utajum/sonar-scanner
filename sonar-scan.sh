...
run_scan() {
    ...
    printf "${NEON_GREEN}║${NC}  ${WHITE}DIRECTORY:${NC}  ${DIM}%-46s${NC}  ${NEON_GREEN}║${NC}\n" "$target_dir"
    echo -e "${NEON_GREEN}║${NC}  ${WHITE}HOST:${NC}       ${NEON_PURPLE}${SONAR_HOST}${NC}                           ${NEON_GREEN}║${NC}"
    echo -e "${NEON_GREEN}║${NC}  ${WHITE}MODE:${NC}       ${NEON_YELLOW}FULL CODE ANALYSIS${NC}                              ${NEON_GREEN}║${NC}"
    echo -e "${NEON_GREEN}║${NC}                                                              ${NEON_GREEN}║${NC}"
    echo -e "${NEON_GREEN}╚══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    ...
    if [ $scan_exit_code -eq 0 ]; then
        ...
        echo -e "${NEON_GREEN}║${NC}                                                              ${NEON_GREEN}║${NC}"
        echo -e "${NEON_GREEN}║${NC}  ${WHITE}Login:${NC}     ${NEON_YELLOW}admin${NC}                                            ${NEON_GREEN}║${NC}"
        echo -e "${NEON_GREEN}║${NC}  ${WHITE}Password:${NC}  ${NEON_YELLOW}Sonarscanner1!${NC}                                   ${NEON_GREEN}║${NC}"
        echo -e "${NEON_GREEN}║${NC}                                                              ${NEON_GREEN}║${NC}"
        echo -e "${NEON_GREEN}╚══════════════════════════════════════════════════════════════╝${NC}"
    else
        echo -e "${RED}╔══════════════════════════════════════════════════════════════╗${NC}"
        ...
        echo -e "${RED}║${NC}  Exit code: ${scan_exit_code}"
        echo -e "${RED}║${NC}                                                              ${RED}║${NC}"
        echo -e "${RED}╚══════════════════════════════════════════════════════════════╝${NC}"
        exit $scan_exit_code
    fi
...
download_issues() {
    ...
    echo -e "${NEON_YELLOW}║${NC}  ${WHITE}MODE:${NC}     ${NEON_PURPLE}EXPORT ALL ISSUES${NC}                                 ${NEON_YELLOW}║${NC}"
    echo -e "${NEON_YELLOW}║${NC}                                                              ${NEON_YELLOW}║${NC}"
    echo -e "${NEON_YELLOW}╚══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
...
delete_docker_images() {
    ...
    echo -e "${NEON_ORANGE}║${NC}  ${WHITE}MODE:${NC}  ${NEON_PURPLE}REMOVE SONARQUBE DOCKER IMAGES${NC}                       ${NEON_ORANGE}║${NC}"
    echo -e "${NEON_ORANGE}║${NC}                                                              ${NEON_ORANGE}║${NC}"
    echo -e "${NEON_ORANGE}╚══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
